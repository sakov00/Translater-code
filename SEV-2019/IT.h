...
#define TI_CHAR_DEFAULT  NULL		//значение по умолчанию дл€ char
...
#define TI_CHAR_MAXSIZE     255		//максимально допустима€ длина строки char
#define TI_CHAR_MINSIZE    3		//минимально допустима€ длина строки char


namespace IT
{
	enum IDDATATYPE { NUM = 1, STR = 2, CHR = 3 };	        //типы данных идентификаторов
	...
	struct Entry
	{
		...
		union
		{
			...
			struct
			{
				int count;							//количество символов в char
				char chr[TI_CHAR_MAXSIZE];						//символы char
			}vchr;
